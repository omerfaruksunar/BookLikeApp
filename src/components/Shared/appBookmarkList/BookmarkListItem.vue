<template>
    <!-- <div  class="p-2 grid grid-cols-8 gap-4"> -->
      <div    class="bg-white flex flex-col gap-x-3 rounded-md shadow-sm " style="height: 180px;">
              <div class="p-3">
...
import { mapGetters } from 'vuex';
  ...
  export default {
      ...
      item: {
        type: Object,
        required: true,
        default: () => ({ title: '', url: '', categoryId: 0, description: '', userId: 0 })
      },
    },
    methods: {
      ...
      likeItem(){
          this.$appAxios({
            url: this.alreadyLiked ? `/user_likes/${this.bookmarkedItem.id}` : "/user_likes",
